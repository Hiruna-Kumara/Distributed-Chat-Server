...
//                    leaderStateInstance.addServerDefaultMainHalls();
    ...
    public boolean isLeader() {
        return ServerState.getInstance().getServerIDNum() == LeaderState.getInstance().getLeaderID();
    }
    ...
    public boolean isLeaderElectedAndIamLeader() {
        return (BullyAlgorithm.leaderFlag && ServerState.getInstance().getServerIDNum() == LeaderState.getInstance().getLeaderID());
    }
